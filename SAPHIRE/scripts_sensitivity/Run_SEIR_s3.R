...
# E0 consists of cases from Jan 4-7
# P0 consists of cases from Jan 1-3
init_sets_list <- generate_init_condi(r0 = 0.23, De=4, Dp=3)

SEIRfitting(init_sets_list, randomize_startValue=T, run_id = "s3", output_ret = T)
